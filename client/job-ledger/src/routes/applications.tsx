...
const ApplicationsPage = () => {
  ...
  return (
    ...
    <section className="rounded-[32px] border border-slate-100 bg-gradient-to-br from-slate-900 via-indigo-900 to-blue-900 p-6 text-white shadow-2xl sm:p-8">
      <div className="flex flex-col gap-8 lg:flex-row lg:items-center">
        <div className="space-y-4">
          ...
          <h1 className="text-3xl font-black sm:text-4xl">Build your application pipeline with intention.</h1>
        ...
        <div className="w-full space-y-4 rounded-[28px] border border-white/30 bg-white/10 p-5 text-sm lg:flex-1">
    ...
    <div className="rounded-[32px] border border-slate-100 bg-white/90 p-6 shadow-2xl shadow-slate-200/60 sm:p-8">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <Link
          to="/job-feed"
          className="inline-flex items-center gap-2 self-start rounded-full border border-slate-200 px-5 py-2 text-sm font-semibold text-slate-700"
        >
